    ...
    <footer className="mt-32" style={{ backgroundColor: "rgba(37, 38, 65, 1)" }}>
      <div className="max-w-lg mx-auto">
        ...
        <div className="text-center pb-16 pt-5">
          ...
          <div className="px-5 sm:px-0 flex flex-col sm:flex-row sm:space-x-3 space-y-3 sm:space-y-0 justify-center mt-3">
            <input
              ...
              className="rounded-full py-2 pl-5 bg-transparent border border-gray-400 text-white placeholder-gray-400 focus:outline-none focus:border-blue-400"
            />
            <button
              type="button"
        ...
        <div className="flex items-center text-gray-400 text-sm justify-center">
          <Link href="#!" className="pr-3 hover:text-white transition">
            Careers
          </Link>
          <Link href="#!" className="border-l border-gray-400 px-3 hover:text-white transition">
            Privacy
          </Link>
          <Link href="#!" className="border-l border-gray-400 pl-3 hover:text-white transition">
            Terms &amp; Conditions
          </Link>
        </div>
          ...
          <div className="py-3 tracking-wide">
            <p>
              ...
              <span className="font-semibold">
                <a
                  href="https://github.com/MSami345/"
                  target="_blank"
